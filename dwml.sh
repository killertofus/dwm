...
sudo wget  https://github.com/ryanoasis/nerd-fonts/releases/latest/download/Iosevka.tar.xz --directory-prefix=/usr/share/fonts/Iosevka | sudo tar -xz  Iosevka.tar.xz -C /usr/share/fonts/Iosevka
sudo rm -rf *.xz/usr/share/fonts/Iosevka
sudo apt update
...
sudo wget -NP /etc/apt/sources.list.d/ https://dl.winehq.org/wine-builds/ubuntu/dists/ lsb_release -c .sources
sudo apt update
